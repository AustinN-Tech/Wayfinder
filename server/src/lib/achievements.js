...
const STAMP_DISPLAY = [
  ...
  ["small_collection", "/images/stamp-icons/small-collection-stamp.png", "items catalogued", "#a18a35"],
  ["medium_collection", "/images/stamp-icons/medium-collection-stamp.png", "items catalogued", "#a66430"],
  ["large_collection", "/images/stamp-icons/large-collection-stamp.png", "items catalogued", "#a27d34"],
  ["dino_hunter", "/images/stamp-icons/dino-hunter-stamp.png", "fossils catalogued", "#8a3226"],
